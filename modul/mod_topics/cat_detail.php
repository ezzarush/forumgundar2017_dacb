...
elseif ($_GET['id'] != '0' && $_GET['cat'] == '0'){
	...
	if (strpos($full_url, "?q=") == TRUE){
		...
		for ($i = 0; $i <= $jml_word; $i++){
			$sql_topic .= "title LIKE '%$explode[$i]%'";
			if ($i < $jml_word){
				$sql_topic .= " OR ";
			}
		}
...
echo "<table border='0' width='100%' class='tr' cellspacing='0'>
	<tr valign='top'>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 10px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Last Topic</td>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 10px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Last Post</td>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 10px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Last Stats</td>
	</tr>
";
...
while ($data_topics = $db->database_fetch_array($sql_topics)){
	...
	echo "<tr valign='top' style='border-bottom: 1px solid #ccc;'>
			<td style='padding: 10px; color: #666;' width='400'>
			...
			<td style='padding:10px; color: #666;'>$comment_date</td>
			<td style='padding:10px; color: #666;'>$stat</td>
		</tr>
		<tr>
