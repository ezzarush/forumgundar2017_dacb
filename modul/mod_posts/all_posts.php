...
echo "<table border='0' width='100%' class='tr' cellspacing='0'>
	<tr valign='top'>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 10px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Topik Terakhir</td>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 0px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Tanggal</td>
		<td style='border-bottom: 1px solid rgba(255, 255, 255, 0.7); padding: 5px 3px 3px 0px; background-color: #3498db; color: #FFFFFF; font-weight: bold;'>Status</td>
	</tr>
";
